...
function () {
  function Form(data) {
    ...
    //set original data
    this.originalData = data; //get field throw loop in data and also declare field let so out of scope its not change
  ...
  _createClass(Form, [{
    ...
    value: function submit(requestType, url) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        axios[requestType](url, _this.data()) //when success
...
__webpack_require__(/*! C:\xampp\htdocs\vue\form\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\vue\form\resources\sass\app.scss */"./resources/sass/app.scss");
